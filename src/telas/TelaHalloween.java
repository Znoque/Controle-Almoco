 ...
 * @author znoque
 */
public class TelaHalloween extends javax.swing.JFrame {
    ...
    int flag = 0;
    /**
     * Creates new form TelaHalloween
     */
    public TelaHalloween() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Controle Halloween:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHalloween.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaHalloween().setVisible(true);
            }
        });
    }
